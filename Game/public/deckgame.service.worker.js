...
/** @type {string} */
const CACHE_VERSION = '1725775961|431098810';
/** @type {string} */
const CACHE_PREFIX = 'Deck Builder Tut-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'deckgame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["deckgame.html","deckgame.js","deckgame.offline.html","deckgame.icon.png","deckgame.apple-touch-icon.png","deckgame.worker.js","deckgame.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["deckgame.wasm","deckgame.pck","deckgame.side.wasm"];
